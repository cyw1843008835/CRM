...
<div region="center">
	<div class="easyui-tabs" fit="true" border="true" id="tabs">
...
<div class="easyui-accordion" data-options="fit:true,border:false">
	<div title="营销管理" data-options="fit:true,border:false">
	...
	<div title="客户管理"  data-options="iconCls:'icon-khgl'" style="padding:10px;">
		...
		<div title="基础数据管理"  data-options="iconCls:'icon-jcsjgl'" style="padding:10px">
			...
			<a href="javascript:openTab('用户信息管理','userManage.jsp','icon-user')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-user', closable:true" style="width: 150px;">用户信息管理</a>
		</div>
...
<div region="south" style="height: 25px;padding: 5px" align="center">
	版本所有 xxxxx <a href="#" target="_blank">http://www.xxxx.com</a>
</div>
</body>
</html>